      ...
      <div class="table-responsive">
        <table class="table table-striped table-bordered" id="dtBasicExample">
          <thead>
            ...
            <tr><th>Name</th><th>Image</th><th>Price</th><th>Description</th><th>Delete</th></tr>
          </thead>
<?php
while($row= mysqli_fetch_array($res))
{
 echo '<tr><td>'.$row[1].'</td><td><img src='.$row[2].' width="100" height="100"></td><td>'.$row[3].'</td><td>'.$row[4].'</td><td><a href="del.php?sno='.$row[0].'">Delete</a></td></tr>';
}
echo '</table>';
        ...
        <form method ="POST" action="addpro.php" enctype="multipart/form-data">
            ...
            <div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="product_des" class="form-control" placeholder="Enter Product Description">
		        	</div>
        		</div>
